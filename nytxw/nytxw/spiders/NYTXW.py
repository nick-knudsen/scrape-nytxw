...
class NytxwSpider(scrapy.Spider):
    ...
    def start_scraping(self, response):
        ...
        yield SplashRequest(url=url, cookies=cookies_dict, callback=self.parse)
    ...
    def parse(self, response):
        ...
        # )
        #grid = scrapy.Request(url='https://www.nytimes.com/svc/crosswords/v6/puzzle/daily/1993-11-21.json', cookies=cookies_dict)
